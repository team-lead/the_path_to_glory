...
import {ADD_TO_CART, addToCart} from "../../actions/cartActions";
...
class DetailPageComponent extends Component {
    ...
    // clickHandler = event => {
    //     console.log('значение this:', this, event);
    // };
    clickHandler = (e) => {
        e.preventDefault();
                        ...
                        <li className={classes.liStyle}>
                            ...
                            <div className={classes.containerInfo}>
                                ...
                                <Button
                                    ...
                                    name='add to basket'
                                />
                                <button onClick={this.clickHandler}>log</button>
                                <button onClick={(id)=>addToCart(id)}>dispatch</button>
                            </div>
                        </li>
                    </div>
                </Fragment>
